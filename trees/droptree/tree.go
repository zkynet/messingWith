...
func (n *Edge) Insert(value string, data *Item) *Edge {
	...
	case value < n.Value:
		if n.Left == nil {
			n.Left = &Edge{Value: value, T: &Tree{}}
			if data != nil {
	...
	case value > n.Value:
		if n.Right == nil {
			n.Right = &Edge{Value: value, T: &Tree{}}
			if data != nil {
...
func (t *Tree) Insert(value string, data *Item) *Edge {
	// log.Println(t)
	if t.Root == nil {
		// log.Println("root is nil..")
		t.Root = &Edge{Value: value, T: &Tree{}}
		if data != nil {
...
func (t *Tree) Delete(s string) *Edge {
	fakeParent := &Edge{Right: t.Root, T: &Tree{}}
	if t.Root == nil {
		return fakeParent
	}
...
func (t *Tree) Traverse(parent string, level int, n *Edge, f func(string, int, *Edge)) {
	...
	level++
	n.T.Traverse(n.Value, level, n.T.Root, f)
}
